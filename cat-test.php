                    ...
                    <div class="col-md-6">
                        <div class="category_article_body">
                            ...
                            <div class="category_article_title">
                                <h5><a href="single.html" target="_blank">Airbnb launches photo-centric app
            ...
            <div class="col-md-4">
                <div class="widget">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">Canon launches photo centric 00214
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">Samsung galaxy note are the supper
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">Apple launches photo-centric wrist
                                    watch for Android</a>
                            </h3>
                            <span class="media-date"><a href="#">10Aug- 2015</a>, by: <a href="#">Eric
                                    joan</a></span>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">Kodak Hi-Speed shutter double shot
                ...
                <div class="widget reviews m30">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">DSLR is the most old camera at this
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading"><a href="single.html" target="_blank">Samsung is the
                                    best
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">Yasaki camera launches new generic
                ...
                <div class="widget m30">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="single.html" target="_blank">Samsung is the best mobile in the
                                    android market.</a>
                            </h3>
